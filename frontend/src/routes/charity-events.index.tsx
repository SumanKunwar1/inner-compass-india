      ...
      <section className="relative py-20 text-cream overflow-hidden" style={{ background: "linear-gradient(135deg, var(--maroon), var(--maroon-deep))" }}>
        <div className="container-x relative text-center">
          ...
          <div className="mt-8 flex flex-wrap gap-4 justify-center">
            {(upcoming[0] ?? charityEvents[0]) && (
              <Link to="/charity-events/$slug" params={{ slug: (upcoming[0] ?? charityEvents[0]).slug }} className="btn-gold">Book Your Seat</Link>
            )}
